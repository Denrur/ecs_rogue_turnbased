...
class World:
    ...
    def add_processor(self, processor_instance: Processor, priority: int = 0) -> None:
        ...
        # print(processor_instance, processor_instance.priority)
        processor_instance.world = self
        self._processors.append(processor_instance)
        self._processors.sort(key=lambda proc: proc.priority)
    ...
    def component_for_entity(self, entity: object, component_type: Type[C]) -> C:
    ...
    def components_for_entity(self, entity: object) -> Tuple[C, ...]:
    ...
    def has_component(self, entity: object, component_type: Any) -> bool:
    ...
    def add_component(self, entity: object, component_instance: Any) -> None:
        """Add a new Component instance to an Entity.
    ...
    def remove_component(self, entity: object, component_type: Any) -> object:
    ...
    def _get_component(self, component_type: Type[C]) -> Iterable[Tuple[object, C]]:
    ...
    def _get_components(self, *component_types: Type) -> Iterable[Tuple[object, ...]]:
    ...
    @_lru_cache()
    def get_component(self, component_type: Type[C]) -> List[Tuple[object, C]]:
    ...
    def try_component(self, entity: object, component_type: Type):
